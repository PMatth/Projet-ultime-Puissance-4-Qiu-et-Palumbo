...
int StartMenu::showmenu(){
    ...
    while (MenuRuns == 1) {
        ...
        // If the mouse moves upon a button, a message displays
        ...
        if (event.type == SDL_MOUSEMOTION) {
            ...
            bool levels = (x>posLevel.x) && (x< (posLevel.x+posLevel.w)) && (y>posLevel.y) && (y<(posLevel.y + posLevel.h));
        ...
        // If the player clicks on one of the buttons, it will lead to somewhere.
        ...
        if (event.type==SDL_MOUSEBUTTONDOWN) {
            ...
            bool instr = (x>posLevel.x) && (x< (posLevel.x+posLevel.w)) && (y>posLevel.y) && (y<(posLevel.y + posLevel.h)); // useless
            
            bool quits = (x>posQuit.x) && (x< (posQuit.x+posQuit.w)) && (y>posQuit.y) && (y<(posQuit.y + posQuit.h));

            // If player clicks on arcade, then....
            ...
            // If player clicks on "2 players" then...
            ...
            // We could have made an instructions page...
            
//            else if (instr == true){
//                CSurface::OnDraw(Menu_Display, instructions, 0, 0);
//                SDL_Flip(Menu_Display);
//            
//                int diffrun = 1;
//            
...
//                        y = event.motion.y;
//                    
//                        bool fit = (x>PosbacktoD.x) && (x< (PosbacktoD.x+PosbacktoD.w)) && (y>PosbacktoD.y) && (y<(PosbacktoD.y + PosbacktoD.h));
//                    
//                    
//                        if(fit == true){
//                            CSurface::OnDraw(Menu_Display, Background, 0, 0);
...
bool StartMenu::MenuInit(){
    ...
    if ((Level = CSurface::OnLoad("W:/Projets/Puissance4/Newsprites/ToInstructions.bmp")) == NULL) {
        return false;
    }
...
//    if (instructions = CSurface::OnLoad("W:/Projets/Puissance4/Newsprites/instructions.bmp")) == NULL) {
//        return false;
//    }
    ...
    CSurface::Transparent(OneTwo, 255, 0, 255);
//  CSurface::Transparent(instructions, 255, 0, 255);
...
// Resets defines the initial positions of the buttons to be clicked by the player
